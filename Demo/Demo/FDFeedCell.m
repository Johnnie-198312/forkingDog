...
//        [self.contentLabel setContentHuggingPriority:251 forAxis:UILayoutConstraintAxisVertical];
//        [self.contentLabel setContentCompressionResistancePriority:750 forAxis:UILayoutConstraintAxisHorizontal];
//        [self.contentLabel setContentCompressionResistancePriority:750 forAxis:UILayoutConstraintAxisVertical];
        ...
        [self.contentImageView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(self.usernameLabel.mas_top).offset(-8).priority(251);
            make.top.equalTo(self.contentLabel.mas_bottom).offset(8).priority(251);
        }];
...
//        [self.usernameLabel setContentHuggingPriority:249 forAxis:UILayoutConstraintAxisVertical];
//        [self.usernameLabel setContentCompressionResistancePriority:750 forAxis:UILayoutConstraintAxisHorizontal];
//        [self.usernameLabel setContentCompressionResistancePriority:750 forAxis:UILayoutConstraintAxisVertical];
